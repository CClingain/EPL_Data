...
Next, we consider separating the teams based on Goals Against vs. Shots on Target, as these two dimensions also seem promising in maximally separating our data. 
...
There is an even clearer distinction between the two clusters in these two dimensions. The black cluster (Top 4/6 teams) also apepars to be tighter. Interestingly, Middlesborough, Sunderland, and Hull - the three relegated teams -- are close toegether at the bottom of the red cluster.
